...
if (!defined('STORE_BUSINESS_AR')) {
    define('STORE_BUSINESS_AR', 'لملابس الأطفال');
}
...
if (!defined('STORE_NAME_EN')) {
    define('STORE_NAME_EN', 'TinyTrove');
}
...
if (!defined('STORE_HERO_VIDEO_URL')) {
    define('STORE_HERO_VIDEO_URL', 'https://res.cloudinary.com/dhqavjbx6/video/upload/v1774120322/Monte_Carlo_Kids_Fashion_Film_2022___Summer_Collection_4K_HD_y2qfer.webm');
}

if (!defined('STORE_ADS_BANNER_PRIMARY_URL')) {
    define('STORE_ADS_BANNER_PRIMARY_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774120781/Gemini_Generated_Image_nw33hwnw33hwnw33-ezremove_sskwik.png');
}

if (!defined('STORE_ADS_BANNER_SECONDARY_URL')) {
    define('STORE_ADS_BANNER_SECONDARY_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774121028/ChatGPT_Image_Mar_21_2026_07_23_28_PM_ksflal.png');
}

if (!defined('STORE_ADS_BANNER_TERTIARY_URL')) {
    define('STORE_ADS_BANNER_TERTIARY_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774121873/Gemini_Generated_Image_4hjplg4hjplg4hjp_tkm1jn.png');
}

if (!defined('STORE_ONE_TOUCH_BEFORE_URL')) {
    define('STORE_ONE_TOUCH_BEFORE_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774122808/before_jxaldc.png');
}

if (!defined('STORE_ONE_TOUCH_AFTER_URL')) {
    define('STORE_ONE_TOUCH_AFTER_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774122806/after_xodudz.png');
}

if (!defined('STORE_REVIEWS_IMAGE_1_URL')) {
    define('STORE_REVIEWS_IMAGE_1_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774122180/Screenshot_2026-03-21_194138_ivq38o.png');
}

if (!defined('STORE_REVIEWS_IMAGE_2_URL')) {
    define('STORE_REVIEWS_IMAGE_2_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774122112/17733307454a5ade02470fc6c8d17a59e6f69d11c5_thumbnail_999x999_ird2qk.jpg');
}

if (!defined('STORE_HISTORY_SECTION_IMAGE_URL')) {
    // Home "about us" image: keep it tied to secondary banner so one URL update works for both.
    define('STORE_HISTORY_SECTION_IMAGE_URL', STORE_ADS_BANNER_SECONDARY_URL);
}

if (!defined('STORE_BREADCRUMB_BG_URL')) {
    define('STORE_BREADCRUMB_BG_URL', 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774123014/ChatGPT_Image_Mar_21_2026_07_56_44_PM_ge3tqg.png');
}
    ...
    function store_brand_home_categories(): array
    {
        return [
            [
                ...
                'label' => 'جاكيت',
                'image_url' => 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774126243/5100034B-5450_zoom_9_jccnei.jpg',
            ],
            [
                'category_url' => 'filter.php?category=%D9%85%D9%84%D8%A7%D8%A8%D8%B3%20%D8%B5%D9%8A%D9%81%D9%8A%D8%A9',
                'label' => 'مدرسة',
                'image_url' => 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774126324/hand-drawn-school-uniform-element-collection_23-2149847005_pnlqse.avif',
            ],
            [
                'category_url' => 'filter.php?category=%D8%B3%D8%B1%D8%A7%D9%88%D9%8A%D9%84',
                'label' => 'سراويل',
                'image_url' => 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774126571/boys-jeans-bl0611242-lightblue-4_k2jq64.webp',
            ],
            [
                'category_url' => 'filter.php?category=%D8%A3%D8%AD%D8%AF%D9%8A%D8%A9',
                'label' => 'أحذية',
                'image_url' => 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774126397/6c0eafddc18ee6693e923a2c74cdf024ab696e23_750x_xmixic.webp',
            ],
            [
                'category_url' => 'filter.php?category=%D8%A7%D9%83%D8%B3%D8%B3%D9%88%D8%A7%D8%B1%D8%A7%D8%AA%20%D8%A3%D8%B7%D9%81%D8%A7%D9%84',
                'label' => 'اكسسوارات أطفال',
                'image_url' => 'https://res.cloudinary.com/dhqavjbx6/image/upload/v1774126499/15-Best-Baby-Sunglasses-For-2019-2-1_xa1j2i.webp',
            ],
            [
...
if (!function_exists('store_brand_replacements')) {
    ...
    function store_brand_replacements(): array
    {
        return [
            ...
            'عبدالوهاب لملابس الأطفال' => STORE_NAME_FULL_AR,
            'عبد الوهاب لملابس الأطفال' => STORE_NAME_FULL_AR,
            'عبدالوهاب' => STORE_NAME_AR,
            'عبد الوهاب' => STORE_NAME_AR,

            // Arabic brand/content normalization for kids store
            'عبدالوهاب للملابس الرجالية' => STORE_NAME_FULL_AR,
            'عبد الوهاب للملابس الرجالية' => STORE_NAME_FULL_AR,
            ...
            'للملابس النسائية' => STORE_BUSINESS_AR,
            'لملابس الأطفال' => STORE_BUSINESS_AR,
            'ملابس رجالية' => 'ملابس أطفال',
            'الملابس الرجالية' => 'ملابس الأطفال',
            'الأزياء الرجالية' => 'أزياء الأطفال',
            'ازياء رجالية' => 'أزياء أطفال',
            'ملابس نسائية' => 'ملابس أطفال',
            'الملابس النسائية' => 'ملابس الأطفال',
            'الأزياء النسائية' => 'أزياء الأطفال',
            'ازياء نسائية' => 'أزياء أطفال',
            'قمصان' => 'ملابس صيفية',
            'قميص' => 'قطعة صيفية',
            'البناطيل' => 'السراويل',
            'بناطيل' => 'سراويل',
            'أحذية' => 'أحدية',
            'احذية' => 'احدية',
            'اكسسوارات رجالية' => 'اكسسوارات أطفال',
            'إكسسوارات رجالية' => 'اكسسوارات أطفال',
            'تصاميم رجالية' => 'تصاميم أطفال',
            'تصاميم نسائية' => 'تصاميم أطفال',
            'أسلوبك الرجالي' => 'أسلوب أطفال عصري',
            'أسلوبك النسائي' => 'أسلوب أطفال عصري',

            // Arabic neutral grammar normalization (remove feminine tone)
            'تسوقي الآن' => 'تسوق الآن',
            'تسوقي أونلاين' => 'تسوق أونلاين',
            'تسوقي أفضل' => 'تسوق أفضل',
            'تصفية وتسوقي' => 'تصفية وتسوق',
            'استكشفي' => 'استكشف',
            'اكتشفي' => 'اكتشف',
            'غوصي' => 'استكشف',
            'تصفحي الآن' => 'تصفح الآن',
            'انضمي إلينا' => 'انضم إلينا',
            'سجلي دخولك الآن' => 'سجل دخولك الآن',
            'تعرفي علينا الآن' => 'تعرف علينا الآن',
            'اتصلي الآن' => 'اتصل الآن',
            'تحققي من حسابك' => 'تحقق من حسابك',
            'تحققي الآن' => 'تحقق الآن',
            'لم تستلمي الرمز؟' => 'لم تستلم الرمز؟',
            'ليس لديكِ حساب؟' => 'ليس لديك حساب؟',
            'لديكِ حساب بالفعل؟' => 'لديك حساب بالفعل؟',
            'حصولكِ على هذا الخصم قبل انتهائه، اضغطي على الزر أدناه واطلبيه الآن!' => 'احصل على هذا الخصم قبل انتهائه، اضغط على الزر أدناه واطلبه الآن!',
            'ثقتكِ هي أساس نجاحنا، ونسعى دائمًا لتقديم الأفضل لكِ.' => 'ثقتكم هي أساس نجاحنا، ونسعى دائمًا لتقديم الأفضل.',
            'مرحباً بكِ،' => 'مرحباً بك،',
            'بحسابكِ' => 'بحسابك',
            'عميلة سعيدة' => 'عميل سعيد',
            'عميلة' => 'عميل',
            'كزائرة' => 'كزائر',
...
if (!function_exists('store_brand_feminine_regex_replace')) {
     ...
     * Kept intentionally to avoid breaking older calls.
     */
    function store_brand_feminine_regex_replace(string $text): string
    {
        // Legacy helper kept for backward compatibility; no feminine rewriting now.
        return $text;
    }
}
